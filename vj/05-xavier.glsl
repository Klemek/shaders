...
#define F1  preset(midi(29, 11), 0.15, 0.25, 0.00, 0.00)
#define P1  preset(midi(13, 12), 0.65, 0.25, 0.00, 0.00)
...
#define F2  preset(midi(30, 11), 0.55, 0.30, 0.00, 0.00)
...
#define F3  preset(midi(31, 11), 0.40, 0.00, 0.00, 0.00)
#define P3  preset(midi(15, 12), 0.20, 0.00, 0.00, 0.00)
#define B31 preset(midi(31, 12), 1.00, 0.00, 0.00, 0.00)
#define B32 preset(midi(15, 13), 0.00, 0.00, 0.00, 0.00)
#define B33 preset(midi(31, 13), 0.00, 0.00, 0.00, 0.00)

#define F4  preset(midi(00, 12), 0.50, 0.50, 0.00, 0.00)
...
#define F5  preset(midi(01, 12), 0.05, 0.20, 0.00, 0.00)
#define P5  preset(midi(17, 12), 0.10, 0.30, 0.00, 0.00)
