...
#define F1  preset(midi(29, 11), 0.30, 0.20, 0.00, 0.00)
#define P1  preset(midi(13, 12), 0.55, 0.20, 0.00, 0.00)
#define B11 preset(midi(29, 12), 0.00, 1.00, 0.00, 0.00)
...
#define F3  preset(midi(31, 11), 0.45, 0.60, 0.00, 0.00)
#define P3  preset(midi(15, 12), 1.00, 1.00, 0.00, 0.00)
...
#define F4  preset(midi(00, 12), 0.70, 0.70, 0.00, 0.00)
#define P4  preset(midi(16, 12), 0.30, 0.30, 0.00, 0.00)
#define B41 preset(midi(00, 13), 1.00, 1.00, 0.00, 0.00)
#define B42 preset(midi(16, 13), 1.00, 0.00, 0.00, 0.00)
#define B43 preset(midi(00, 14), 0.00, 0.00, 0.00, 0.00)

#define F5  preset(midi(01, 12), 0.50, 1.00, 0.00, 0.00)
#define P5  preset(midi(17, 12), 0.10, 0.15, 0.00, 0.00)
...
#define F6  preset(midi(02, 12), 1.00, 0.00, 0.00, 0.00)
#define P6  preset(midi(18, 12), 0.50, 0.00, 0.00, 0.00)
#define B61 preset(midi(02, 13), 1.00, 0.00, 0.00, 0.00)
#define B62 preset(midi(18, 13), 0.00, 0.00, 0.00, 0.00)
#define B63 preset(midi(02, 14), 0.00, 0.00, 0.00, 0.00)

#define F7  preset(midi(03, 12), 0.00, 0.70, 0.00, 0.00)
#define P7  preset(midi(19, 12), 0.00, 1.00, 0.00, 0.00)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    uv = butt(B41, uv * 
        ...
        sin(uv.y * (P4 - (F4 - .5) + mix(0, sin2(mod(iTime * P5, 1)), B51) * F5) * 10), uv);
